    ...
    return (
        <div className="hidden md:block w-full md:w-4/12 xl:w-3/12 bg-gray-200 pt-5 lg:p-5 rounded-sm ">
            <div className="flex flex-col w-full">
                ...
                <Link
                    to="/bug-report-management"
                    className={`block py-2 px-4 rounded-sm hover:bg-gray-400 ${
                        currentPage === 6 && "bg-gray-400"
                    }`}
                >
                    <i className="fas fa-bug md:mr-2"></i>
                    <span className="mt-2 lg:mt-0">Bug Report Management</span>
                </Link>
            </div>
        </div>
    );
